<template>
  <div class="card flex justify-center">
    <Dialog v-model:visible="chessboard.isEndGame" modal :header="getTitle()" :style="{ width: '25rem' }">
      <span class="text-surface-500 dark:text-surface-400 block mb-8">This is the end of the game. You can ask for a rematch, leave the room or close this window to see the board.</span>
      <div class="flex justify-end gap-2">
        <Button type="button" label="Leave" severity="secondary" icon="fa-solid fa-xmark" @click="leave()"></Button>
        <Button type="button" label="Rematch" icon="fa-solid fa-arrows-rotate" @click=""></Button>
      </div>
    </Dialog>
  </div>
</template>
