...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { GameHistoryController } from './../controllers/gameHistory';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "MoveReplayOutputDTO": {
        ...
        "properties": {
            ...
            "to_y": {"dataType":"double","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GameReplayOutputDTO": {
        ...
        "properties": {
            ...
            "whitePlayer": {"dataType":"union","subSchemas":[{"ref":"UserReplayOutputDTO"},{"dataType":"enum","enums":[null]}]},
            "winner": {"dataType":"union","subSchemas":[{"ref":"UserReplayOutputDTO"},{"dataType":"enum","enums":[null]}]},
            "moves": {"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"refObject","ref":"MoveReplayOutputDTO"}},{"dataType":"enum","enums":[null]}]},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/rooms/all',
            ...
            async function RoomsController_getRooms(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.post('/rooms',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(RoomsController)),
            ...(fetchMiddlewares<RequestHandler>(RoomsController.prototype.createRoom)),

            async function RoomsController_createRoom(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.get('/gameHistories/user/:id',
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getGameHistoriesByUserId',
                controller,
                response,
                next,
                validatedArgs,
        ...
        app.get('/gameHistories/:id',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController)),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController.prototype.getGameHistoryById)),

            async function GameHistoryController_getGameHistoryById(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/gameHistories/percentage/win/:id',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController)),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController.prototype.getWinPercentageByUserId)),

            async function GameHistoryController_getWinPercentageByUserId(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getWinPercentageByUserId',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/gameHistories/average/duration/:id',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController)),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController.prototype.getAverageGameDurationByUserId)),

            async function GameHistoryController_getAverageGameDurationByUserId(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getAverageGameDurationByUserId',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/gameHistories/average/moves/:id',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController)),
            ...(fetchMiddlewares<RequestHandler>(GameHistoryController.prototype.getAverageGameMoveByUserId)),

            async function GameHistoryController_getAverageGameMoveByUserId(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getAverageGameMoveByUserId',
                controller,
                response,
                next,
                validatedArgs,
        ...
        app.post('/auth/refresh',
            ...
            async function AuthenticationController_refresh(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
